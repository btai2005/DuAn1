...
public class Menu extends javax.swing.JPanel {
    ...
    private void initData() {
        ...
        listMenu.addItem(new Model_Menu("4", "Hóa Đơn", Model_Menu.MenuType.MENU));
        ...
        listMenu.addItem(new Model_Menu("7", "Voucher", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("8", "Thoát", Model_Menu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/result_icon for shoe store.png"))); // NOI18N
        jLabel1.setText("SHOES MANAGEMENT");
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, Color.decode("#89cff0"), 0, getHeight(), Color.decode("#21abcd"));
        g2.setPaint(g);
